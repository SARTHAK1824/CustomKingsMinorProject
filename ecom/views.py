...
def customer_address_view(request):
    ...
    if request.method == 'POST':
        ...
        if addressForm.is_valid():
            ...
            Custom_text= addressForm.cleaned_data['Custom_text']
            ...
            response.set_cookie('Custom_text', Custom_text)  # Store the custom text in a cookie
            return response
...
def payment_success_view(request):
    ...
    if 'Custom_text' in request.COOKIES:
        Custom_text = request.COOKIES['Custom_text']
    ...
    for product in products:
        models.Orders.objects.get_or_create(
            customer=customer, product=product, status='Pending', email=email,
            mobile=mobile, address=address, Custom_text=Custom_text  # Include the custom text when creating the order
        )
